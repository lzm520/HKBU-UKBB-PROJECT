...
class HVDM(VDM):
    def __init__(self, X, Y, cat_ix, nan_equivalents=[np.nan, 0], normalised="variance"):
        ...
        Y : array-like of shape = [n_rows]
            List containing categorical output variable
